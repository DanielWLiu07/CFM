...
import { getRingNavTargetFromLocationHash } from './lib/ringNavigate';
...
export default function Home() {
  ...
  // Fallback if inline boot script did not redirect (e.g. hash set after load).
  useEffect(() => {
    const targetUrl = getRingNavTargetFromLocationHash(members, window.location.hash);
    if (targetUrl) {
